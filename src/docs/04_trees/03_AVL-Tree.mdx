...
Exemplo de saída esperada da estrutura da árvore após inserções:
...
Agora o exemplo de saída após remoção do nó 10:

```
===Árvore AVL em ordem após remoção: 20 25 30 40 50===
