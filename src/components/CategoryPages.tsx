          ...
          {pages.map((page) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <h3 className="font-semibold text-gray-900 group-hover:text-blue-700 flex-1 leading-tight">
                  {page.title}
                </h3>
                <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-blue-600 flex-shrink-0 mt-0.5 ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>

              {page.description && (
                <p className="text-sm text-gray-600 group-hover:text-gray-700 line-clamp-3">
                  {page.description}
                </p>
              )}

              <div className="mt-3 flex items-center space-x-2">
                <div className="w-2 h-2 bg-blue-200 group-hover:bg-blue-400 rounded-full transition-colors"></div>
