      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
        <div className="flex-1">
          {previous ? (
            <Link
              ...
              className="group flex items-center space-x-3 p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 w-full"
            >
        ...
        <div className="flex-1">
          {next ? (
            <Link
              href={`/docs/${next.slug}`}
              className="group flex items-center space-x-3 p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 w-full sm:flex-row-reverse sm:space-x-reverse"
            >
              <div className="flex-shrink-0">
